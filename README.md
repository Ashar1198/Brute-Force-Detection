...
A security investigation using **Splunk** to detect brute-force SSH login attacks from real-world authentication logs. Built as part of an academic project, this work covers the full SOC analyst workflow — data ingestion, field extraction, SPL-based detection queries, threat intelligence enrichment, and dashboard construction.
